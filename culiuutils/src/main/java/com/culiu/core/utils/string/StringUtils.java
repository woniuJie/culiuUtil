/**
 * Project Name:culiulib File Name:StringUtils.java Package Name:com.culiu.core.utils.string Date:2014-10-15上午12:40:04 Copyright (c)
 * 2014, adison All Rights Reserved.
 */

package com.culiu.core.utils.string;
...
public class StringUtils {
    ...
    /**
     * Returns true if a.trim() and b.trim() are equal, including if they are both null.
     *
     * @param a first String to check
     * @param b second String to check
     * @return true if a and b are equal
     */
    public static boolean trimEquals(String a, String b) {
        if (a == b)
            return true;
        if (a == null || b == null)
            return false;
     ...
     * @return
     */
    public static float str2Float(String number, float defaultValue) {
        float parseFloat = 0;
        try {
            parseFloat = Float.parseFloat(number);
        } catch (NumberFormatException e) {
    ...
    public static float str2Float(String number) {
        return str2Float(number, 0);
    }

    /**
     * 为textview 分别设置不同的颜色字体
     *
     * @param orgStr
     * @param color
     * @param start
     ...
     * @return
     */
    public static SpannableString setDiffColorForText(String orgStr, int color, int start, int end) {
        SpannableString ss = new SpannableString(orgStr);
        /**
         * 如果传的start or end 值不对 就返回原始字符
         */
        if (start < 0 || end < 0 || start > orgStr.length() || end > orgStr.length() || start > end) {
            return ss;
        }
    ...
    /**
     * formatDouble 格式化价格，保留两位小数，末尾为0舍去
     *
     * @param num
     * @return
     */
    public static String formatDoubleToString(double num) {
        ...
        formatstr = formatstr.replaceAll("[0]$", "");
        formatstr = formatstr.replaceAll("[0]$", "");
    ...
    /**
     * getMoneyString 格式化价格，保留两位小数，末尾为0舍去，并添加人民币符号
     *
     * @param num
     * @return
     */
    ...
    public static String getDiscount(String discount) {
        BigDecimal bigDecimal = new BigDecimal(discount); // doubel的构造函数会有误差，用String就ok
        String result = Float.toString(bigDecimal.setScale(1, BigDecimal.ROUND_HALF_UP).floatValue()); // 表明四舍五入，保留一位小数
    ...
    public static
    @NonNull
    String getNonNullString(String str) {
        if (TextUtils.isEmpty(str)) {
            return "";
        } else {
            return str;
     ...
     * @return
     */
    public static String float2Money(float money) {
        BigDecimal b = new BigDecimal(money);
        float m = b.setScale(2, BigDecimal.ROUND_HALF_UP).floatValue();
        return m + "";
    }
     ...
     * @return
     */
    public static String float2Money2(float money) {
     ...
     * @return
     */
    public static int mersureStringLength(String value) {
        int valueLength = 0;
        String chinese = "[\u4e00-\u9fa5]";
     ...
     * @return
     */
    public static String cutStringLength(String value, int cutNum) {
