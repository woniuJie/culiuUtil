package com.culiu.core.utils.setting;
...
public class SettingUtils {
	...
	public static float getSharedPreferences(Context context, String paramString,
                                             float paramFloat) {
		return getSharedPreferencesObject(context)
	...
	public static void setEditor(Context context, String paramString,
                                 float paramFloat) {
		getEditorObject(context).putFloat(paramString, paramFloat).commit();
	}
